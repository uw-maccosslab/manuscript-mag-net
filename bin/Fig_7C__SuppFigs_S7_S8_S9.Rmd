...
R Markdown to generate box plots for Figure 7C and Supplementary Figures X, Y, and Z.
...
Note that the 4 box plots generated here end with the shared file ID "_partial.svg" as a couple of manual changes were made to better align the labels for the x/y axes and the sample legends.
...
Note that the receiver operating characteristic (ROC) curves were generated using script titled "".
...
* **Supplementary Figure 7:** Panel of 12 individual protein box plots. Proteins were found to be increased in ADD and involved in vesicle mediated transport

* **Supplementary Figure 8:** Panel of 8 individual protein box plots. Proteins were found to proteins that were found to be increased in ADD and are involved in lipid metabolism.

* **Supplementary Figure 9:** Panel of 16 individual protein box plots. Proteins were found to proteins that were found to be increased in ADD and are involved in Ubiquitin-proteasome mediated protein degradation.
...
knitr::opts_knit$set(echo = TRUE, collapse = TRUE, warning=FALSE, message=FALSE, root.dir = 'C:\\Users\\Kristine\\Desktop\\MagNet\\Mag-Net')
...
# Import organizer containing proteins of interest
        organizer <- read.csv("input\\Protein_List.csv", 
                              header = TRUE,
                              na.strings="#N/A",
                              sep = ",")

# Data to generate box plots.
        ADPD_proteins <- read.csv("input\\20230812-particlesADPD_pilot-batchadj-Prot.csv", 
                              header = TRUE,
                              na.strings="#N/A",
                              sep = ",") 

    # Metadata for AD/PD experiment
        ADPD_meta <- read.csv("input\\TPAD HCN_ADD_PDD_PDCN Plasma - Metadata.csv", 
                              header = TRUE,
                              na.strings="#N/A",
                              sep = ",")     

    # ROC and significance values
        ad_roc <- read.csv("input\\mag-net_biomarker_rocs-final.csv", 
                              header = TRUE,
                              na.strings="#N/A",
                              sep = ",")     
...
# Figure _ and Supplementary Figures _ {.tabset .tabset-fade}
...
#       ggsave(file = paste("output\\",basename,adpdinfo,"Boxplot_",selected_protein,"_normalizedabundance.svg", sep = ""), plot=boxplot_protein, width=figure_width, height=figure_height)
# 
# # Export individual plots as .png files
#     print(paste0("5/5: Exporting ",selected_protein, " plot to .png file"))
#       ggsave(file = paste("output\\",basename,adpdinfo,"Boxplot_",selected_protein,"_normalizedabundance.png", sep = ""), plot=boxplot_protein, width=figure_width, height=figure_height)
...
* Opened "Figure_A_partial.svg" file in Inkscape.
...
# Applying patchwork layout and altering annotations specified above
  figure_draft_nolabels_adpd <- (shared_y + increase_1 + increase_2 + increase_3 + increase_4 + increase_5 + decrease_1 + decrease_2 + decrease_3 + decrease_4 + decrease_5 + shared_x + legend + plot_layout(design = fig_layout) & ylab(NULL) & xlab(NULL))  

    
# Export Figure 7Cs .svg file
  ggsave(file = paste("output\\",basename,adpdinfo,"Figure_A_partial.svg", sep=""), plot=figure_draft_nolabels_adpd, width=(box_width*6), height=(box_height*3))
...
Supplementary Figure 7 shows 12 proteins that were found to be increased in ADD and involved in vesicle mediated transport.
...
* Opened "Supplementary_Figure_X_VMT_partial.svg" file in Inkscape.
...
* Re-saved as "Supplementary_Figure_X_VMT.svg"
...
# Applying patchwork layout and altering annotations specified above
figure_draft_nolabels_vmt <- (shared_y + plot_1 + plot_2 + plot_3 + plot_4 + plot_5 + plot_6 + plot_7 +  plot_8 + plot_9 + plot_10 + plot_11 + plot_12 + shared_x + legend + plot_layout(design = fig_layout_vmt) & ylab(NULL) & xlab(NULL)) 

# Export Figure 7Cs .svg file
  ggsave(file = paste("output\\",basename,adpdinfo,"Supplementary_Figure_X_","VMT_partial",".svg", sep=""), plot=figure_draft_nolabels_vmt, width=(box_width*5), height=(box_height*4))
...
Supplementary Figure 8 shows 8 proteins that were found to be increased in ADD and are involved in lipid metabolism.

<br/><br/>

To generate the final supplementary figure version in the manuscript, a few manual changes were made offline using a vector graphics editor:

* Opened "Supplementary_Figure_Y_Lipid_partial.svg" file in Inkscape.
...
* Re-saved as "Supplementary_Figure_Y_Lipid.svg"
...
# Applying patchwork layout and altering annotations specified above
figure_draft_nolabels_lipid <- (shared_y + plot_1 + plot_2 + plot_3 + plot_4 + plot_5 + plot_6 + plot_7 +  plot_8 + shared_x + legend + plot_layout(design = fig_layout_lipid) & ylab(NULL) & xlab(NULL)) 

# Export Figure 7Cs .svg file
  ggsave(file = paste("output\\",basename,adpdinfo,"Supplementary_Figure_Y_","Lipid_partial",".svg", sep=""), plot=figure_draft_nolabels_lipid, width=(box_width*5), height=(box_height*3))
...
Supplementary Figure 9 shows 16 proteins that were found to be increased in ADD and are involved in Ubiquitin-proteasome mediated protein degradation.

<br/><br/>

To generate the final supplementary figure version in the manuscript, a few manual changes were made offline using a vector graphics editor:

* Opened "Supplementary_Figure_Z_Ubiquitin_partial.svg" file in Inkscape.
...
* Re-saved as "Supplementary_Figure_Z_Ubiquitin.svg"
...
# Applying patchwork layout and altering annotations specified above
figure_draft_nolabels_ubiq <- (shared_y + plot_1 + plot_2 + plot_3 + plot_4 + plot_5 + plot_6 + plot_7 +  plot_8 + plot_9 + plot_10 + plot_11 + plot_12 + plot_13 + plot_14 + plot_15 + plot_16 + shared_x + legend + plot_layout(design = fig_layout_ubiq) & ylab(NULL) & xlab(NULL)) 

# Export Figure 7Cs .svg file
  ggsave(file = paste("output\\",basename,adpdinfo,"Supplementary_Figure_Z_","Ubiquitin_partial",".svg", sep=""), plot=figure_draft_nolabels_ubiq, width=(box_width*5), height=(box_height*5))
